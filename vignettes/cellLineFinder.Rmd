...
devtools::install_github('DijkJel/cellLineFinder')
...
The cellFinderPackage includes a summary of RNA-sequencing and WES data from DepMap and WES data from the COSMIC cell line project.
...
The package contains only two functions to visualize the data: findCellLine() and plotHeatmap().
